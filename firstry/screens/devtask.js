...
class taj extends Component {
    ...
    <Image
        ...
        />      
            ...
            <Text style={{textAlign: 'right',fontSize: 16, marginLeft:1, marginBottom: 15}}>- github pages </Text>
            ...
            <Text style={{textAlign: 'right',fontSize: 16, marginLeft:1, marginBottom: 15}}>- using serverless </Text>
